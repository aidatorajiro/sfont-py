...
struct Zone {
      list<GeneratorList*> generators;
      list<ModulatorList*> modulators;
      int instrumentIndex;
      };
...
class SoundFont {
      ...
      char* readString(int);
      void readPhdr(int);
      void readBag(int, list<Zone*>*);
      void readMod(int, list<Zone*>*);
      void readGen(int, list<Zone*>*);
      void readInst(int);
      void readShdr(int);
      ...
      void writeSmpl();
      void writePhdr();
      void writeBag(const char* fourcc, list<Zone*>*);
      void writeMod(const char* fourcc, const list<Zone*>*);
      void writeGen(const char* fourcc, list<Zone*>*);
      void writeInst();
      void writeShdr();
