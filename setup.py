...
mac_build = "clang++ -dynamiclib -L/usr/local/lib -lsndfile -logg -lvorbis -lvorbisfile -lvorbisenc -F/usr/local/opt/qt/lib -framework QtCore -framework QtXml -std=c++11 interface.cpp -o sfont.dylib"
